...
export default tseslint.config(
  ...
  {
    // Test doubles and the scaffolded template legitimately contain unused
    // parameters; keep those warnings rather than errors.
    files: ["**/test/**/*.ts", "**/*.test.ts", "templates/**/*.ts"],
